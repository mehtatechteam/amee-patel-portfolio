...
export function StickyWhatsApp() {
  ...
  return (
    ...
    >
      {/* Tooltip text pill */}
      <div
        className={`hidden rounded-full bg-ink/90 px-4 py-2 text-xs font-semibold text-paper shadow-xl backdrop-blur-md transition-all duration-300 sm:block ${
          hovered
      ...
      >
        ...
        <svg
          ...
          fill="currentColor"
          aria-hidden="true"
          className="relative drop-shadow-sm transition-transform group-hover:scale-105"
        >
